...
// #define HAL_Delay(x) (rcc_msDelay(x))
#define I2C_TRANSMIT(addr, buf, len, time) (HAL_I2C_Master_Transmit(&i2c1Handle, addr, buf, len, time))
#define I2C_RECEIVE(addr, buf, len, time) (HAL_I2C_Master_Receive(&i2c1Handle, addr, buf, len, time))
